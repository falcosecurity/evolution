...
| [falcosecurity/falco-exporter](https://github.com/falcosecurity/falco-exporter)             | [![Deprecated](https://img.shields.io/badge/status-deprecated-inactive?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#deprecated) | Prometheus Metrics Exporter for Falco output events.                                                                              |
...
| [falcosecurity/libs-sdk-go](https://github.com/falcosecurity/libs-sdk-go)                   | [![Sandbox](https://img.shields.io/badge/status-sandbox-red?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#sandbox)               | Go SDK for Falco libs.                                                                                                            |
| [falcosecurity/plugin-sdk-cpp](https://github.com/falcosecurity/plugin-sdk-cpp)             | [![Sandbox](https://img.shields.io/badge/status-sandbox-red?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#sandbox)               | Falco plugins SDK for C++.                                                                                                        |
| [falcosecurity/k8s-metacollector](https://github.com/falcosecurity/k8s-metacollector)       | [![Incubating](https://img.shields.io/badge/status-incubating-orange?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#incubating)   | Fetches the metadata from kubernetes API server and dispatches them to Falco instances.                                           |
| [falcosecurity/falco-talon](https://github.com/falcosecurity/falco-talon)                   | [![Incubating](https://img.shields.io/badge/status-incubating-orange?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#incubating)   | Response Engine for managing threats in your Kubernetes.                                                                          |
| [falcosecurity/plugin-sdk-rs](https://github.com/falcosecurity/plugin-sdk-rs)               | [![Incubating](https://img.shields.io/badge/status-incubating-orange?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#incubating)   | Falco plugins SDK for Rust.                                                                                                       |
...
|                                                 NAME                                                  |                                                                                   STATUS                                                                                    |                                           DESCRIPTION                                           |
|-------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [falcosecurity/cncf-green-review-testing](https://github.com/falcosecurity/cncf-green-review-testing) | [![Sandbox](https://img.shields.io/badge/status-sandbox-red?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#sandbox)             | Falco configurations intended for testing with the CNCF Green Reviews Working Group.            |
| [falcosecurity/dbg-go](https://github.com/falcosecurity/dbg-go)                                       | [![Incubating](https://img.shields.io/badge/status-incubating-orange?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#incubating) | A go tool to work with falcosecurity drivers build grid.                                        |
...
| [falcosecurity/kernel-testing](https://github.com/falcosecurity/kernel-testing)                       | [![Incubating](https://img.shields.io/badge/status-incubating-orange?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#incubating) | Ansible playbooks to provision firecracker VMs and run Falco kernel tests.                      |
| [falcosecurity/falco-playground](https://github.com/falcosecurity/falco-playground)                   | [![Sandbox](https://img.shields.io/badge/status-sandbox-red?style=for-the-badge)](https://github.com/falcosecurity/evolution/blob/main/REPOSITORIES.md#sandbox)             | falco-playground is a web application used to validate Falco rules and test against scap files. |
<!-- /REPOSITORY-INFRA-TABLE -->
